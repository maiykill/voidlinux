...
" Start
" Define the catppuccin color scheme here rather than
" having a new file for that so in future if you need to
" remove the colorscheme for new one just delete this 
